...
# ================================================================================
# 实验配置：ResNetADownStages + 从头训练 48 epochs（NightDrone 数据集）
...
# 
# 对比基线：faster-rcnn_r50_fpn_scratch_2x_nightdrone.py (标准ResNet，无预训练)
...
val_evaluator = dict(
    ...
    format_only=False,
    classwise=True,
    outfile_prefix='./work_dirs/nightdrone_adown_stages_scratch_2x/val'
)
...
test_evaluator = dict(
    ...
    format_only=False,
    classwise=True,
    outfile_prefix='./work_dirs/nightdrone_adown_stages_scratch_2x/test'
)
...
# -------------------- 工作目录 --------------------
work_dir = './work_dirs/nightdrone_adown_stages_scratch_2x'
